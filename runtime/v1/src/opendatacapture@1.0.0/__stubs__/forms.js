...
/**
 * @typedef {import('../schemas/core.js').Language} Language
 * @typedef {{ favoriteNumber: number, reasonFavoriteNumberIsNegative?: string; }} FormInstrumentStubData
 */

/** @type {import('./utils.js').InstrumentStub<import('../schemas/instrument').FormInstrument<FormInstrumentStubData, Language>>} */
